  ...
  up: async (queryInterface, Sequelize) => {
    ...
    */
    await queryInterface.bulkInsert('Subproducts', [
      ...
      // ENTRADAS
      {
        productId: 1, image: 'entradas/hot-chiles.jpg', name: 'Hot Chiles (2pz)', price: 35,
        description: 'Chiles caribes empanizados rellenos de philadelphia tapico y queso chester.', 
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 2, image: null, name: 'Dedos de Queso (3pz)', price: 40,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 3, image: null, name: 'Papas a la Francesa', price: 35,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 3, image: null, name: 'Papas Gajo', price: 55,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 4, image: null, name: 'Boneless BBQ', price: 75,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 4, image: null, name: 'Boneless Bufalo', price: 75,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 5, image: null, name: 'Alitas BBQ (10pz)', price: 75,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 5, image: null, name: 'Alitas Bufalo (10pz)', price: 75,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 6, image: null, name: 'Arosshito Pollo', price: 65,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 6, image: null, name: 'Arosshito Res', price: 65,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 6, image: null, name: 'Arosshito Mix+Camaron', price: 65,
        description: null, createdAt: new Date(), updatedAt: new Date()
      },

      // BEBIDAS
      {
        productId: 7, image: 'bebidas/te.jpg', name: 'Te', price: 15,
        description: '1/2 lt', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 7, image: 'bebidas/te.jpg', name: 'Te', price: 25,
        description: '1 lt', createdAt: new Date(), updatedAt: new Date()
      },

      {
        productId: 8, image: 'bebidas/uvola.jpg', name: 'Uvola', price: 20,
        description: '1/2 lt', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 8, image: 'bebidas/uvola.jpg', name: 'Uvola', price: 25,
        description: '1 lt', createdAt: new Date(), updatedAt: new Date()
      },

      {
        productId: 9, image: null, name: 'Liminada Natural', price: 20,
        description: '1/2 lt', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 9, image: null, name: 'Liminada Natural', price: 25,
        description: '1 lt', createdAt: new Date(), updatedAt: new Date()
      },

      {
        productId: 9, image: null, name: 'Liminada Mineral', price: 25,
        description: '1/2 lt', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 9, image: null, name: 'Liminada Mineral', price: 35,
        description: '1 lt', createdAt: new Date(), updatedAt: new Date()
      },

      {
        productId: 10, image: null, name: 'Frappuchino Oreo', price: 48,
        description: 'Chico', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 10, image: null, name: 'Frappuchino Oreo', price: 58,
        description: 'Grande', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 10, image: 'bebidas/frappe-moka.jpg', name: 'Frappuchino Moka', price: 48,
        description: 'Chico', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 10, image: 'bebidas/frappe-moka.jpg', name: 'Frappuchino Moka', price: 58,
        description: 'Grande', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 10, image: null, name: 'Frappuchino Mazapan', price: 48,
        description: 'Chico', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 10, image: null, name: 'Frappuchino Mazapan', price: 58,
        description: 'Grande', createdAt: new Date(), updatedAt: new Date()
      },

      {
        productId: 11, image: null, name: 'Pepsi', price: 12,
        description: '', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 11, image: null, name: 'Naranja', price: 12,
        description: '', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 11, image: null, name: 'Toronja', price: 12,
        description: '', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 11, image: null, name: '7UP', price: 12,
        description: '', createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 11, image: null, name: 'Manzana', price: 12,
        description: '', createdAt: new Date(), updatedAt: new Date()
      },

      // SUSHI CLASICOS 12
      {
        productId: 12, image: 'sushis/clasicos/california.png', name: 'California', price: 65,
        description: 'por dentro: philadelphia, aguacate, pepino y surimi por fuera: ajaonjoli rollo natural',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 12, image: 'sushis/clasicos/bombazo.png', name: 'Bombazo', price: 70,
        description: 'por dentro philadelphia, aguacate, pepino y surimi rollo empanizado',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 12, image: 'sushis/clasicos/tres-quesos.png', name: '3Quesos', price: 75,
      ...
      {
        productId: 12, image: 'sushis/clasicos/cielo-mar-y-tierra.png', name: 'Cielo Mar y Tierra', price: 75,
        description: 'por dentro philadelphia, aguacate, pollo, res y camaron, rollo empanizado',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 12, image: 'sushis/clasicos/guamuchilito.png', name: 'Guamuchilito', price: 79,
      ...
      {
        productId: 12, image: 'sushis/clasicos/sushi-ball.png', name: 'Shushi Ball', price: 65,
      ...
      // SUSHI DE LA CASA 13
      {
        productId: 13, image: null, name: 'Cordon Blue', price: 79,
      ...
      {
        productId: 13, image: 'sushis/casa/culiacancito.jpg', name: 'Culiacancito', price: 95,
      ...
      {
        productId: 13, image: null, name: 'Harlem', price: 79,
        description: 'por dentro philadelphia, aguacate, pollo y tocino por fuera gratinado con chile caribe rollo natural',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 13, image: 'sushis/casa/houston.jpg', name: 'Houston Roll', price: 85,
      ...
      {
        productId: 13, image: 'sushis/casa/kany.jpg', name: 'KANY ROLL', price: 95,
      ...
      {
        productId: 13, image: 'sushis/casa/mochilito.jpg', name: 'MOCHILITOS', price: 95,
      ...
      {
        productId: 13, image: 'sushis/casa/manhattan.jpg', name: 'MANHATTAN ROLL', price: 79,
        description: 'por dentro philadelphia, aguacate, res y camaron, gratinado con tocino rollo natural',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 13, image: 'sushis/casa/mt-roll.jpg', name: 'MT.', price: 79,
        description: 'por dentro philadelphia, aguacate, res y tocino, gratinado con serrano natural, rollo natural',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 13, image: 'sushis/casa/nevo-roll.jpg', name: 'NEVO ROLL', price: 95,
      ...
      {
        productId: 13, image: null, name: 'NEVADO ROLL', price: 95,
      ...
      {
        productId: 13, image: 'sushis/casa/plancha-especial.jpg', name: 'PLANCHA ESPECIAL', price: 79,
        description: 'cama de arroz empanizada, philadelphia pollo res, camaron gratinada aguacate y salsa de anguila',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 13, image: 'sushis/casa/super-chesster.jpg', name: 'SUPER CHESTER', price: 89,
      ...
      // HAMBURGUESAS 14
      {
        productId: 14, image: 'hamburguesas/clasica.png', name: 'CLASICA', price: 70,
      ...
      {
        productId: 14, image: 'hamburguesas/brooklin.png', name: 'BROOKLYN', price: 85,
      ...
      {
        productId: 14, image: 'hamburguesas/campirana.png', name: 'CAMPIRANA', price: 85,
      ...
      {
        productId: 14, image: 'hamburguesas/rosevelt.png', name: 'ROSEVELT', price: 85,
      ...
      {
        productId: 14, image: 'hamburguesas/tery-burgers.png', name: 'TERY BURGER', price: 85,
      ...
      {
        productId: 14, image: 'hamburguesas/texas.png', name: 'TEXAS', price: 85,
      ...
      {
        productId: 14, image: 'hamburguesas/crazy-cheese-burgers.jpg', name: 'CRAZY CHEESE BURGER', price: 85,
      ...
      {
        productId: 14, image: 'hamburguesas/jalapeño-burgers.png', name: 'JALAPEÑO BURGER', price: 99,
      ...
      {
        productId: 14, image: null, name: 'TROPY BURGER', price: 99,
      ...
      {
        productId: 14, image: 'hamburguesas/boneless-burgers.png', name: 'BONELES BURGER', price: 85,
      ...
      // COMBOS 15
      {
        productId: 15, image: 'combos/paquete-llenes-1.jpg', name: 'PAQUETE  LLENES 1', price: 139,
        description: '1 bombazo + 1 pz de hot chile + 1/2 orden de boneles +  litro de te',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 15, image: null, name: 'PAQUETE LLENES 2', price: 129,
        description: '1 california + 1/2 arshito de pollo + 2 dedos de queso + litro de te',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 15, image: null, name: 'PAQUETE LLENES 3', price: 139,
        description: '1 bombazo + 1 pz de hot chile + 1/2 orden de alitas +  litro de te',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 15, image: null, name: 'Combo Arroshito', price: 149,
      ...
      // OTROS 15
      {
        productId: 16, image: null, name: 'Toping De Tampico', price: 20,
        description: '',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 16, image: null, name: 'Toping De Camaron', price: 20,
        description: '',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 16, image: null, name: 'Gratinado Adicional', price: 15,
        description: '',
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        productId: 16, image: null, name: 'Anguila', price: 5,
        description: '',
        createdAt: new Date(), updatedAt: new Date()
      },
    ])
